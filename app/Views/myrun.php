...
<body>
    <div class="backbox">
        <a href='home' class="backmyrun"><i class="fas fa-arrow-left"></i></a>
    </div>
    <div class="list_body">
       <div class="list_head">
           <p id="P01">id</p>
       ...
       <?php foreach($myrun as $data){ ?>
       <form action="myrunup" method="POST">
           ...
           <input id="P03" value="<?php echo $data['s_name'] ?>"></input>
           <input type="submit" value="comfirm" id="P04"></input>
